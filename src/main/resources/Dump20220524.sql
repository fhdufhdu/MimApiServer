...
INSERT INTO `comment` VALUES (1,1,'1',0,0,'2022-05-11 05:13:47.000000',1,'fhdufhdu'),(2,2,'2',0,0,'2022-05-12 05:13:47.000000',1,'fhdufhdu'),(3,3,'3',0,0,'2022-05-13 05:13:47.000000',1,'fhdufhdu'),(4,1,'4',1,0,'2022-05-14 05:13:47.000000',1,'fhdufhdu'),(5,5,'5',0,1,'2022-05-15 05:13:47.000000',1,'fhdufhdu'),(6,1,'6',1,1,'2022-05-15 05:13:47.000000',1,'fhdufhdu'),(7,7,'7',0,0,'2022-05-15 05:13:47.000000',1,'admin');
...
CREATE TABLE `favorite_movie` (
  ...
  `user_id` varchar(255) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `FKirq7peag832xom8fpp9h74bqm` (`movie_id`),
  KEY `FK7ocotjv06j7kpkmba7tkjqtw2` (`user_id`),
  CONSTRAINT `FK7ocotjv06j7kpkmba7tkjqtw2` FOREIGN KEY (`user_id`) REFERENCES `member` (`id`),
  CONSTRAINT `FKirq7peag832xom8fpp9h74bqm` FOREIGN KEY (`movie_id`) REFERENCES `movie` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `favorite_movie` VALUES (1,'2022-05-11 05:13:47.000000',1,'fhdufhdu'),(2,'2022-05-11 05:13:47.000000',2,'fhdufhdu'),(3,'2022-05-11 05:13:47.000000',3,'admin');
